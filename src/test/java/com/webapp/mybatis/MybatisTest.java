...
//		InputStream inputStream = Resources.getUrlAsStream("file:mybatis_config.xml");
//		FileInputStream inputStream = new FileInputStream("mybatis_config.xml");
...
//		FileInputStream inputStream = new FileInputStream(file);
		...
		File file = ResourceUtils.getFile("file:mybatis_config.xml");
		FileInputStream inputStream = new FileInputStream(file);
		...
		Member m = session.selectOne("com.webapp.dao.MemberDao.selectById", 1004);
			System.out.println(m.getId() +" "+ m.getEmail());
